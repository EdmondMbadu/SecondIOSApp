...
class NewTableViewController: UITableViewController {
   ...
   var monsters = ["Astro", "Fluffy","Munchie","Squido"]
    ...
    // Table View Controllers inherit methods that alow them to define
    // what the Table View Controler looks like
    // This method defines the number of section the Table View Controller tll have
    ...
    // it gets called the same number of times s there are ows in each section
    // The indexPath object is a Swift struct that exnapsulates the section
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        // the cell has textLabel (Title), imageView, and it has
